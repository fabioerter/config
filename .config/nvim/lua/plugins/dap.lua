...
return {
        ...
        config = function()
                ...
                vim.keymap.set("n", "<F5>", dap.continue, {desc = "Start Debbugger"})
                vim.keymap.set("n", "<S-F5>", dap.continue, {desc = "Start Debbugger"})
                ...
                vim.keymap.set("n", "<leader>dA", dap.attach, {})
                        ...
                        dap.configurations[value] = {
                                {
                                        ...
                                        env = function()
                                                ...
                                                print("env.dll.target_path: " .. dll.target_path)
                                        ...
                                        program = function()
                                                local dll = ensure_dll()
                                                print("program.dll.target_path: " .. dll.target_path)
                                        ...
                                        cwd = function()
                                                local dll = ensure_dll()
                                                print("absolute_project_path: " .. dll.absolute_project_path)
