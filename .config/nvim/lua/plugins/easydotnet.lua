...
--                         else
--                                 local secret_path = home_dir ..
--                                     "/.microsoft/usersecrets/" .. secret_guid .. "/secrets.json"
--                                 path = secret_path
--                         end
--                         return path
--                 end
...
--                                         debug_test_from_buffer = { lhs = "<leader>db", desc = "debug from buffer" },
...
--                                 local commands = {
--                                         run = function()
--                                                 return string.format("dotnet run --property:ASPNETCORE_ENVIRONMENT=Development --project %s %s", path, args)
--                                         end,
--                                         test = function()
